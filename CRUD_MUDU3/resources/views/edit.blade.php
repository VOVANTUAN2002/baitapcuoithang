            ...
            <div class="col-12">
                <form method="post" action="{{route('customers.update', $customer->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="id" placeholder="Enter Mã nhân viên" value="{{$customer->id}}">
                    ...
                    <div class="form-group">
                        <label>Họ tên</label>
                        <input type="text" class="form-control" name="name" placeholder="Họ tên" value="{{$customer->name}}">
                        <span style="color:red;">@error("name"){{ $message }} @enderror</span>
                    </div>
                    <div class="form-group">
                        <label>Ngày sinh</label>
                        <input type="date" class="form-control" name="birthday" placeholder="Enter Ngày Sinh" value="{{$customer->birthday}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" placeholder="Enter Phone" value="{{$customer->phone}}">
                        <span style="color:red;">@error("phone"){{ $message }} @enderror</span>
                    </div>
                    <div class="form-group">
                        <label>Số CMND</label>
                        <input type="text" class="form-control" name="CMND" placeholder="Enter CMND" value="{{$customer->CMND}}">
